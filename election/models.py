...
class ElectionConfig(models.Model):
    ...
    block_time_generation = models.IntegerField(default=5)
    ...
    min_votes_in_block = models.IntegerField(null=False, blank=False, default=5)
    min_votes_in_last_block = models.IntegerField(null=False, blank=False, default=5)
